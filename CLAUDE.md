...
| APK PRO TERM | `build/releases/proterm/android/app-proterm-v1.7.0-build96.apk` | 2026-08-03 15:52 (bump 1.7.0+96 — build de TEST peste cf70a78, branch feature/programari-restyle-lot4, include Lot 4 (ULTIMA restilizare pură din plan): AppCard elevated pe cardul "Profitabilitate estimată" (tab Financiar, appointment_form_dialog.dart) + 2 chips informative -> AppStatusChip, restilizare strict izolată de closures-urile setDialogState/StatefulBuilder din _openEditor(); dart analyze 0 erori, flutter test 243/243; aapt: ro.proterm.proventaris versionCode 96 versionName 1.7.0; 103MB; SHA256 `7331BB62E53F8813B872972B3FB91FA1DD9E0CAF581A1793D8B8627ACC3EEFE5`; build tag `rel-20260803-1559`; via scripts/build_proterm.ps1; **PUBLICAT** 2026-08-03 ~16:20 via `node scripts/publish_release.js --version 1.7.0 --build 96` — Firebase Storage upload OK, Firestore `app_config/version_info` actualizat, autoupdate live pentru toți angajații PRO TERM) |
| ZIP Windows PRO TERM | `build/releases/proterm/windows/proventaris-windows-v1.7.0-build96.zip` | 2026-08-03 16:07 (bump 1.7.0+96 — build de TEST, aceeași sesiune ca APK-ul de mai sus; 65MB; SHA256 `8D9AD95B951C2E98C5CDEEF7AB89C9A885945EA0D531198E5C8E77D99685E093`; cache Windows curățat automat înainte de build; build tag `rel-20260803-1559`; via scripts/build_proterm.ps1; **PUBLICAT** — vezi nota APK de mai sus) |
