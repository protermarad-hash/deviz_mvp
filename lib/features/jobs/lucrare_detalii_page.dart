...
class _LucrareDetaliiPageState extends State<LucrareDetaliiPage> {
  ...
  late final LucrarePdfBuilder _pdfBuilder = LucrarePdfBuilder(
    laborCalc: _laborCalc,
    sanitizePdfText: _sanitizePdfText,
    commercialValue: _commercialValue,
  ...
  Map<String, String> _parseAiDocumentSections(String content) =>
      parseAiDocumentSections(content);
  ...
  Future<Uint8List> _buildDocumentPdfBytes(Map<String, dynamic> row) async {
    ...
    return _pdfBuilder.buildDocumentPdfBytes(
      ...
      laborFallback: _labor,
      beneficiaryEquipmentFallback: _beneficiarySuppliedEquipment,
      beneficiaryMaterialsFallback: _beneficiarySuppliedMaterials,
      assignedTeam: _assignedTeam,
      assignedTeamMembersLabel: _assignedTeamMembersLabel,
    );
  }
  ...
  List<Map<String, dynamic>> _payloadRows(
    ...
    String key,
      ...
      _pdfBuilder.payloadRows(payload, key);

  Future<Uint8List> _buildCompleteReportPdfBytes(
    Map<String, dynamic> payload,
  ) async {
    final companyMap = await _loadCompanyBrandingMap();
    return _pdfBuilder.buildCompleteReportPdfBytes(
      payload,
      companyMap: companyMap,
    );
  }
