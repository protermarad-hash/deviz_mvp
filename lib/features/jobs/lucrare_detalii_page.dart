...
class _LucrareDetaliiPageState extends State<LucrareDetaliiPage> {
  ...
  Future<JobPartner?> _showPartnerDialog({JobPartner? existing}) async {
              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () {
                    ...
                    if (name.isEmpty) {
                      _snack('Completeaza numele partenerului.');
                      return;
                    }
  ...
  Future<JobPartnerWorker?> _showPartnerWorkerDialog({
    ...
    final currencyCtrl = TextEditingController(
        text: existing?.currency.trim().isNotEmpty == true
            ...
            : 'RON');
    final notesCtrl = TextEditingController(text: existing?.notes ?? '');
    final masterWorkers = _masterWorkersForJobPartner(partner);
              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () {
                    ...
                    if (fullName.isEmpty) {
                      _snack('Completeaza numele persoanei.');
                      return;
                    }
                    Navigator.of(context).pop(
                      JobPartnerWorker(
                        ...
                        workedHours: _asDouble(hoursCtrl.text),
                        hourlyRate: _asDouble(rateCtrl.text),
  ...
  Future<JobPartnerVehicle?> _showPartnerVehicleDialog({
    ...
    final currencyCtrl = TextEditingController(
        text: existing?.currency.trim().isNotEmpty == true
            ...
            : 'RON');
    final notesCtrl = TextEditingController(text: existing?.notes ?? '');
    final masterVehicles = _masterVehiclesForJobPartner(partner);
                ...
                FilledButton(
                  onPressed: () {
                    ...
                    if (vehicleName.isEmpty) {
                      _snack('Completeaza numele autovehiculului.');
                      return;
                    }
                    Navigator.of(context).pop(
                      JobPartnerVehicle(
                        ...
                        km: _asDouble(kmCtrl.text),
                        fuelConsumptionPer100Km:
                            _asDouble(consumptionCtrl.text),
                        fuelPricePerLiter: _asDouble(fuelPriceCtrl.text),
                        currency: currencyCtrl.text.trim().isEmpty
                            ? 'RON'
                            : currencyCtrl.text.trim().toUpperCase(),
                        notes: notesCtrl.text.trim(),
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                final name = nameCtrl.text.trim();
                if (name.isEmpty) {
                  _snack('Completeaza denumirea echipamentului.');
                  return;
                }
                Navigator.of(context).pop(
                  BeneficiarySuppliedEquipment(
                    ...
                    quantity: _asDouble(quantityCtrl.text),
                    notes: notesCtrl.text.trim(),
                  ),
                );
              },
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                final name = nameCtrl.text.trim();
                if (name.isEmpty) {
                  _snack('Completeaza denumirea materialului.');
                  return;
                }
                Navigator.of(context).pop(
  ...
  Future<JobOwnVehicle?> _showOwnVehicleDialog({
              ...
              content: SizedBox(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      if (_masterOwnVehicles.isNotEmpty)
                        DropdownButtonFormField<String?>(
                          initialValue: selectedMasterVehicleId != null &&
                                  _masterOwnVehicles.any(
                                    (item) =>
                                        item.id == selectedMasterVehicleId,
                                  )
                              ? selectedMasterVehicleId
  ...
  Future<Map<String, dynamic>?> _openWorkTaskDialog({
    ...
    final workersController = TextEditingController(
      text: _workTaskWorkers(initial ?? const <String, dynamic>{}).join(', '),
    );
    DateTime start =
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                              'Start: ${_formatDate(start)} ${start.hour.toString().padLeft(2, '0')}:${start.minute.toString().padLeft(2, '0')}'),
                        ),
                        TextButton.icon(
                          onPressed: pickStart,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                              'Final: ${_formatDate(end)} ${end.hour.toString().padLeft(2, '0')}:${end.minute.toString().padLeft(2, '0')}'),
                        ),
                        TextButton.icon(
                          onPressed: pickEnd,
              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () {
                    ...
                    if (title.isEmpty) {
                      _snack('Completeaza denumirea etapei.');
                      return;
                    }
                    if (!end.isAfter(start)) {
                      _snack('Ora de final trebuie sa fie dupa ora de start.');
                      return;
                    }
