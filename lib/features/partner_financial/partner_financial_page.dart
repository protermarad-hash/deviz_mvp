  ...
  Future<void> _syncFromAppointments() async {
    try {
      ...
      if (toUpsert.isNotEmpty) {
        await _repository.upsertTransactionsBatch(toUpsert);
      }
    } catch (_) {
