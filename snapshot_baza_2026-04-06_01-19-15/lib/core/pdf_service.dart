        ...
        build: (context) => [
                  ...
                  pw.Container(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        if (valueText(offer['locatie_lucrare']).trim().isNotEmpty)
                          _detailBlock(
                            'Locație lucrare',
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  if (valueText(offer['client_contact_person']).trim().isNotEmpty)
                    pw.Text(
          ...
          if (valueText(offer['notes']).trim().isNotEmpty) ...[
            ...
            pw.Container(
              ...
              child: pw.Text('Observatii: ${offer['notes']}'),
            ),
          ],
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    children: [
                      ...
                      _summaryRow(
                        'Total fără TVA',
                        _money(totalNoVat, currency, eurRate),
                      ),
                      _summaryRow(
    ...
    if (Platform.isWindows) {
      ...
      if (userProfile == null || userProfile.trim().isEmpty) {
        throw const FileSystemException(
          'Folderul Downloads nu a putut fi determinat.',
        );
      }
  ...
  pw.Widget _buildCompanyBlock(CompanySettings company) {
    return pw.Column(
      ...
      children: [
        ...
        if (company.companyCui.isNotEmpty) pw.Text('CUI: ${company.companyCui}'),
