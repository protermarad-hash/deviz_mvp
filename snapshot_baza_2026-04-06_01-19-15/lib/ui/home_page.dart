...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('DevizPro Ultra')),
      body: Row(
        children: [
          NavigationRail(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  _StatCard(
                      title: 'Clienti', value: '${data?['clients'] ?? 0}'),
                  _StatCard(
                    title: 'Materiale',
                    value: '${data?['materials'] ?? 0}',
                  ),
                  _StatCard(
                    title: 'Angajati activi',
...
class _ClientsPageState extends State<ClientsPage> {
  ...
  Future<void> _editClient([Map<String, dynamic>? client]) async {
    ...
    await showDialog<void>(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(client == null ? 'Client nou' : 'Editeaza client'),
        content: SizedBox(
          width: 420,
          child: Column(
            ...
            children: [
              ...
              _textField(contact, 'Persoana contact'),
...
class _MaterialsPageState extends State<MaterialsPage> {
  ...
  Future<void> _editMaterial([Map<String, dynamic>? material]) async {
    ...
    await showDialog<void>(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(material == null ? 'Material nou' : 'Editeaza material'),
        content: SizedBox(
          width: 420,
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              _textField(unit, 'UM'),
              _numberField(price, 'Pret vanzare'),
            ],
          ),
        ),
        actions: [
    ...
    await showDialog<void>(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          title: Text(employee == null ? 'Angajat nou' : 'Editeaza angajat'),
          content: SizedBox(
            width: 520,
            child: Column(
              mainAxisSize: MainAxisSize.min,
...
class _VehiclesPageState extends State<VehiclesPage> {
  ...
  Future<void> _editVehicle([VehicleRecord? vehicle]) async {
    ...
    final leasing = TextEditingController(
      text: (vehicle?.leasingCostOptional ?? 0).toStringAsFixed(2),
    );
    ...
    await showDialog<void>(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          title:
              Text(vehicle == null ? 'Autoturism nou' : 'Editeaza autoturism'),
          content: SizedBox(
            width: 520,
              ...
              onPressed: () async {
                await widget.repository.saveVehicle(
                  VehicleRecord(
                    ...
                    leasingCostOptional: parseDouble(leasing.text),
...
class _OfferEditorPageState extends State<OfferEditorPage> {
  ...
  CompanySettings _currentCompany() {
    return CompanySettings(
      ...
      companyLogoBase64: _logoBase64,
      defaultCurrency:
          _resolveDropdownValue(_currency, _currencyDropdownOptions, fallback: 'RON') ??
              'RON',
                    ...
                    children: [
                      DropdownButtonFormField<String>(
                        ...
                        items: materialOptions
                            ...
                            .toList(),
                        onChanged: (value) {
                          debugPrint('[OfferDialog] selected material id: $value');
  ...
  Future<void> _exportPdf() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('PDF exportat: $fileName')),
    );
  }
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                  ...
                  child: clientOptions.isEmpty
                      ...
                      : DropdownButtonFormField<String>(
                          ...
                          items: clientOptions
                              ...
                              .toList(),
                          onChanged: (value) {
                            debugPrint('OfferEditor selected client id: $value');
                ...
                SizedBox(width: 140, child: _numberField(_eurRate, 'Curs EUR')),
                SizedBox(
                  width: 140,
                  child: _numberField(
                    _vatPercent,
                ...
                SizedBox(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(labelText: 'Mod regie'),
                  ),
                ),
                SizedBox(
                  width: 140,
            ...
            Wrap(
              ...
              children: [
                SizedBox(
                    width: 320, child: _textField(_companyName, 'Nume firma')),
                SizedBox(
                    width: 260, child: _textField(_companyPhone, 'Telefon')),
                SizedBox(width: 320, child: _textField(_companyEmail, 'Email')),
                ...
                SizedBox(width: 260, child: _textField(_companyBank, 'Banca')),
                SizedBox(width: 320, child: _textField(_companyIban, 'IBAN')),
                SizedBox(
                  width: 260,
                  child: _textField(_companyContactName, 'Persoana contact'),
                ),
                SizedBox(
                  width: 620,
                  child: TextField(
            ...
            Wrap(
              ...
              children: [
                OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.image_outlined),
                  label:
                      Text(_logoBase64 == null ? 'Alege logo' : 'Schimba logo'),
                ),
                if (_logoBase64 != null)
                  TextButton(
                    onPressed: () => setState(() => _logoBase64 = null),
                      ...
                      .map(
                        (entry) => DataRow(
                          cells: [
                            ...
                            DataCell(
                                Text(entry.value.quantity.toStringAsFixed(2))),
                            DataCell(
                              Text(
                                formatMoney(
                      ...
                      .map(
                        (entry) => DataRow(
                          cells: [
                            ...
                            DataCell(Text(
                                entry.value.workedHours.toStringAsFixed(2))),
                            DataCell(Text(
            ...
            Row(
              ...
              children: [
                ...
                FilledButton.icon(
                  ...
                  icon: const Icon(Icons.save),
                  label: Text(
                    _offerId == null ? 'Salveaza oferta' : 'Salveaza modificarile',
                  ),
                ),
                const SizedBox(width: 12),
                FilledButton.tonalIcon(
                  ...
                  label: const Text('Salveaza si inchide'),
                ),
              ],
            ),
          ],
...
List<_DropdownOption> _clientDropdownOptions(List<Map<String, dynamic>> clients) {
